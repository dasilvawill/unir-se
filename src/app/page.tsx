  ...
  return (
    <>
      ...
      <div className="bg-white">
        <div className="lg-p-12 relative isolate px-6 lg:py-2">
          <div
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-48">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                diferença! Oferecemos suporte vital para comunidades afetadas
                por desastres naturais, conflitos e crises humanitárias.
                Junte-se a nós para fornecer assistência essencial, reconstruir
                vidas e restaurar a esperança. Saiba mais sobre como estamos
                promovendo o bem-estar global e como você pode se envolver para
                fazer parte dessa causa significativa.
              </p>
